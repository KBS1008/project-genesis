...
export async function bootstrapApplication(
  ...
  const companyBrainRepository =
    options.companyBrainRepository ?? new InMemoryCompanyBrainRepository();
  ...
  const seedMarketResult = marketPriceSeeder.seed(
