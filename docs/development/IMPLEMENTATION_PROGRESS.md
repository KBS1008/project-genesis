...
| M10 Content Expansion            | 🟡 In Progress (Gate 0 ✅ · Phase 1 ✅ · Phase 2 ✅ · Phase 3 ✅ · Phase 4 ✅) |
...
**Tests:** 638 (run `pnpm test` for current count; `pnpm test:e2e` for M9 API flows)
...
| M10 | Content Expansion      | 🟡 In Progress |       55 |     8,3 % |        4,6 % |
...
### M10 – Content Expansion 🟡 (~55 % · Gate 0 ✅ · Phase 1 ✅ · Phase 2 ✅ · Phase 3 ✅ · Phase 4 ✅)
...
| Content pipeline / registry     |      60 | Loaders, strict validation, M10 content tests |
| **Milestone average**           |  **55** | Phase 5 company management next              |
...
1. **M10 Phase 5 — Company Management:** departments, employees, specialization per `M10_CONTENT_EXPANSION_PLAN.md`
