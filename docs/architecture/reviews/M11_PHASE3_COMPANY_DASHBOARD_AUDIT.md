...
| S9 | `TutorialPanel` | 563 | `@/components/TutorialPanel` | `PGTutorialPanel` | **P6** ✅ |
...
| `apps/web/src/components/DataTable.tsx` | **Removed** |
| `apps/web/src/components/TickHistoryCharts.tsx` etc. | **Removed** |
| `apps/web/src/components/icons/DashboardIcons.tsx` | **Moved** → `presentation/icons/DashboardIcon.tsx` |
...
- Gate 3 review — **done** (`M11_GATE_3_DASHBOARD_REVIEW.md`)
- Gate 3 cleanup C1–C4 — **done** (guide, tutorial migration, dead code, chart axe)
